...
1. Wenn mindestens eine Zeile fehlerhaft ist, wird der komplette Upload abgebrochen.
2. Nur die fehlerhaften Zeilen werden übersprungen, während alle anderen importiert werden (aktuelles Verhalten). Wenn allerdings der Header einer Spalte fehlt oder falsch geschrieben ist (z.B. „Vertragsnummer“ falsch), wird der gesamte Upload abgebrochen.
...
1. Einen Benutzerhinweis anzeigen wie „Die Verarbeitung läuft noch. Möchten Sie die Seite wirklich verlassen?“
2. Eine Progressbar anzeigen.
3. Den Upload abbrechen, wenn der User die Seite verlässt oder aktualisiert – das widerspricht allerdings der Aufgabenstellung, die explizit verlangt, dass der Import robust sein soll.
